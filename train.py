...
pretrained_model_dir = "" ## pretrained model if required
data_dir = "datasets/three_wind_datasets/training_data.npy" ## data directory
...
start_epoch = 0
use_lr_scheduler = True ## if use the learning rate scheduler
k_folds = 5 ## cross-validation

savefolder = "three_wind_datasets" ## the folder to save the trained model
